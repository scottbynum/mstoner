...
gulp.task('build', gulp.series('clean', gulp.parallel(gulp.series('svgstore-sass', 'sass'), 'browserify', 'images', 'fonts', 'svgstore', 'nunjucks')));
...
gulp.task('init', gulp.series('clean', gulp.parallel(gulp.series('svgstore-sass', 'sass'), 'watchify', 'images', 'fonts', 'svgstore', 'nunjucks')));
